<template>
  <div class="w-full bg-white flex justify-between border-2 border-gray-300">
    ...
    <div class="flex">
      ...
      <div v-if="!web3Injected" class="bg-purple-800 mt-6 mb-6 mx-5 text-white px-5 py-2 rounded-lg cursor-pointer" @click="connectWallet">Connect Wallet</div>
      ...
      <div v-else class="bg-purple-800 mt-6 mb-6 mx-5 text-white px-3 py-2 rounded-lg cursor-pointer" @click="connectWallet">Connect Wallet</div>
    </div>
  </div>
</template>
